...
<body>
    ...
    <table width="100%">
        <tr valign="top">
            <td>
                ...
                <h1 style="margin: 0;"><strong>Factuur</strong></h1>
            </td>
            <td align="right">
        ...
        <tr>
            <td width="70%">
                <table width="100%">
                    <tr>
                        <td width="100%">
                            <p>{{env('ZCLIENT_ADDRESS')}} <br>
                {{env('ZCLIENT_ZIPCODE')}} {{env('ZCLIENT_CITY')}}</p>
                <hr>
            ...
            <td align="right" width="20%">
                <table width="100%" style="text-align: right;" cellpadding="5">
                    ...
                    <tr>
                        <td align="right">Bestelnummer:</td>
                        <td>{{ $detail->attributes->order_number }}</td>
                    </tr>
                    <tr>
                        <td align="right">Besteldatum:</td>
                        <td>{{ date('d.m.Y', strtotime($detail->attributes->order_date)) }}</td>
                    </tr>
                    <tr>
                        <td align="right">Datum levering:</td>
                        <td>{{ date('d.m.Y', strtotime($detail->attributes->delivery_end_date)) }}</td>
                    </tr>
                    <tr>
                        <td align="right">Datum factuur:</td>
                        <td>{{ date('d.m.Y', strtotime($detail->attributes->order_date)) }}</td>
                    </tr>
                    <tr>
    ...
    <table width="100%" cellpadding="5">
        ...
        <tr style="border-bottom: 1px solid #000;" align="left">
            ...
            <th width="5%">Leverancier art-nr.</th>
            ...
            <th width="15%">Totaalprijs {{ $detail->attributes->order_lines_price_currency }}</th>
            <th width="15%">VAT %</th>
        </tr>
        <tr>
    ...
    <table width="100%">
        ...
        <tr valign="top">
            ...
            <td>
                ...
                Begunstigde: Zalando Payments GmbH <br>
                GmbH  <br>

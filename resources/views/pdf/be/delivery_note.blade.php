...
<body>
    ...
    <table width="100%">
        <tr valign="top">
            <td>
                ...
                <h2 style="margin: 0;"><strong>Levering</strong></h2>
            </td>
            <td align="right">
        ...
        <tr>
            ...
            <td align="right" width="50%">
                <table width="100%" style="border: 1px solid #ddd;" cellpadding="5">
                    ...
                    <tr>
                        <th align="left">Datum leveringsbon:</th>
        ...
        <tr>
            <td><br>
            Overzicht van uw bestelling             </td>
        </tr>
    </table>
    <br>
    <table width="100%" cellpadding="5">
        ...
        <tr style="border-bottom: 1px solid #000;" align="left">
            ...
            <th width="20%">Benaming</th>
            <th width="10%">Maat</th>
            <th width="10%">Kwantiteit</th>
            <th width="15%">Stukprijs</th>
        ...
        <tr>
            <td align="right" colspan="6"><strong>Totaalbedrag EUR</strong></td>

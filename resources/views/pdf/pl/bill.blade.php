...
<body>
    ...
    <table width="100%">
        <tr valign="top">
            ...
            <img src="{{ env('CLIENT_LOGO') }}" alt="" width="100">
                <h1 style="margin: 0;"><strong>Faktura</strong></h1>
            </td>
            <td align="right">
    ...
    <table width="100%" cellpadding="5">
        ...
        <tr style="border-bottom: 1px solid #000;" align="left">
            ...
            <th width="5%">szt.</th>
            <th width="35%">numer przedmiotu</th>
            <!-- <th width="10%">Größe</th> -->
            <th width="20%">Artykuły</th>
            <th width="20%">Cena jednostkowa netto {{ $detail->attributes->order_lines_price_currency }}</th>
            <th width="15%">Całkowita kwota podatku VAT {{ $detail->attributes->order_lines_price_currency }}</th>
            <th width="15%">VAT %</th>
        </tr>
        <tr>
        ...
        <tr>
            <td align="right" colspan="5">Łączna kwota netto {{ $detail->attributes->order_lines_price_currency }}</td>
            <td>{{ str_replace(".", ",", $totalWPrice) }}</td>
        </tr>
        <tr>
            <td align="right" colspan="5">Całkowita kwota podatku VAT {{ $detail->attributes->order_lines_price_currency }}</td>
            <td>{{ str_replace(".", ",", $totalVat) }}</td>
        </tr>
        <tr>
            <td align="right" colspan="5"><strong>Łączna kwota brutto {{ $detail->attributes->order_lines_price_currency }}</strong></td>

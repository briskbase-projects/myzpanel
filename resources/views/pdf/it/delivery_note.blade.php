    ...
    <table width="100%">
        <tr valign="top">
            <td>
                ...
                <h2 style="margin: 0;"><strong>Documento di consegna</strong></h2>
            </td>
            <td align="right">
        ...
        <tr>
            ...
            <td align="right" width="50%">
                <table width="100%" style="border: 1px solid #ddd;" cellpadding="5">
                    ...
                    <tr>
                        <th align="left">Data dell'ordine:</th>
                        <td>{{ date('d.m.Y', strtotime($detail->attributes->order_date)) }}</td>
                    </tr>
                    <tr>
                        <th align="left">Data di consegna:</th>
                        <td>{{ date('d.m.Y', strtotime($detail->attributes->order_date)) }}</td>
                    </tr>
                </table>
            </td>
        ...
        <tr>
            <td><br>
            Ricapitolando il vostro ordine:            </td>
        </tr>
    </table>
    <br>
...
Unitario</th>
        ...
        <tr>
            <td align="right" colspan="6"><strong>Importo totale EUR</strong></td>
    ...
    <table width="100%">
        <tr>
            <td>
                <p>Volete cambiare il vostro articolo? Per restituire un prodotto si prega di seguire le istruzioni per la compilazione del modulo “Istruzioni
per il reso” e ordinare di nuovo l´articolo desiderato su Zalando.it. Non vi è alcun costo aggiuntivo: consegna e reso sono facili e
gratuiti!</p>
